              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: RFRichText(text: name, overflow: TextOverflow.ellipsis, color: Colors.black87, size: 14.sp, weight: FontWeight.bold,),
                  ),
                  SizedBox(height: 4.h),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Icon(Icons.email_outlined, size: 16.h, color: Colors.blueAccent.withOpacity(0.8),),
                            SizedBox(width: 4.w),
                            Expanded(child: RFRichText(text: email, overflow: TextOverflow.ellipsis, size: 13.sp, color: Colors.black87, weight: FontWeight.normal,)),
                          ],
                        ),
                      ],
                    ),
